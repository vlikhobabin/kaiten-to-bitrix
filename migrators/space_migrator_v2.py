"""
Новый мигратор пространств Kaiten в группы Bitrix24.
Логика: 
...
class SpaceMigratorV2:
    """
    Мигратор пространств из Kaiten в группы Bitrix24.
    Новая логика: переносим пространства, а не доски.
    """
    ...
    async def _save_space_mapping(self, stats: Dict):
        ...
        mapping_file = Path(__file__).parent.parent / "mappings" / "space_mapping_v2.json"
        ...
        mapping_data = {
            ...
            "description": "Маппинг ID пространств Kaiten -> рабочих групп Bitrix24 (новая логика)",
