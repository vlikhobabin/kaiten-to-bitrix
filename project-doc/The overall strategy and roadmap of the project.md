...
*   **Задача 6: Разработка мигратора пространств и участников (Spaces -> Workgroups)**
    *   **Описание:** Создать мигратор для пространств. Он должен получать пространства из Kaiten, создавать для каждого соответствующий Проект/Группу в Bitrix24. Используя маппинг ID из предыдущей задачи, добавить в созданную группу соответствующих участников.
    *   **Критерии приемки:**
