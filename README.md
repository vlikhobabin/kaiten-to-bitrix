...
├── 📁 migrators/       # Логика миграции разных объектов
...
- **Models** - типизированные Pydantic модели для валидации данных
- **Transformers** - преобразование данных между форматами Kaiten и Bitrix24
- **Migrators** - специализированные мигаторы для каждого типа объектов
...
Заполните файл `.env` (см. [руководство по безопасности](SECURITY.md)):
...
- **API тесты** - с мокированием внешних сервисов
...
- **[Тесты](tests/)** - примеры и документация по тестированию
...
- **Типизация** - Pydantic модели для всех данных
...
3. Создать мигратор в `migrators/`
4. Добавить скрипт в `scripts/`
